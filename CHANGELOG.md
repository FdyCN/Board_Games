...
- **情书（Love Letter）**：引擎已实现（隐藏信息 + 回合制 + 淘汰制）。3 人 PPO vs 2 随机对手胜率稳定在 **~76-77%**（v1 绝对视角 77%、v2 相对视角 75.5%、对手池+信念+上帝视角 77%，均 200 局）。上帝视角辅助头确能学会推断对手手牌（aux_loss 2.03→1.63），但未转化为胜率；对手池也未让价值函数转正（explained_variance ≈ 0）。
