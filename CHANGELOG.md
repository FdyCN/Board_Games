...
- **情书（Love Letter）**：引擎已实现（隐藏信息 + 回合制 + 淘汰制）。3 人 vs 2 随机对手胜率：**GRU+私密知识 78.5%**（新最佳）、PPO/MLP 77%、相对视角 75.5%、NFSP 59%、手写规则 bot ~71%、随机 33%。修掉「神父/男爵/国王失忆」bug（known 矩阵追踪私密知识）+ 换 GRU 序列编码器（有序事件时间线）。
